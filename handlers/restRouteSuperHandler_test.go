...
// func TestRRt_HandleClientInsertMedia(t *testing.T) {
// 	var c mgr.Client
...
// func TestRRt_HandleClientInsertReq(t *testing.T) {
// 	var c mgr.Client
// 	//c.ClientID = clientHandid
// 	c.APIKey = "123456"
// 	c.Enabled = true
...
// func TestRRt_HandleClientInsertMethod(t *testing.T) {
// 	var c mgr.Client
// 	c.ClientID = clientHandid
// 	c.APIKey = "123456"
// 	c.Enabled = true
...
func TestRRt_HandleRestRouteInsertMedia(t *testing.T) {
	...
	//r.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
	hrr.HandleRestRouteSuperChange(w, r)
	fmt.Print("Code: ")
	fmt.Println(w.Code)
	b, _ := ioutil.ReadAll(w.Body)
	var bdy mgr.GatewayResponse
...
// func TestRRt_HandleClientUpdateMedia(t *testing.T) {
// 	var c mgr.Client
// 	c.ClientID = clientHandid
// 	c.APIKey = "123456"
// 	c.Enabled = false
...
// func TestRRt_HandleClientUpdateReq(t *testing.T) {
// 	var c mgr.Client
// 	//c.ClientID = clientHandid
// 	c.APIKey = "123456"
// 	c.Enabled = false
...
// func TestRRt_HandleClientUpdateMethod(t *testing.T) {
// 	var c mgr.Client
// 	c.ClientID = clientHandid
// 	c.APIKey = "123456"
// 	c.Enabled = false
...
// func TestRRt_HandleClientUpdate(t *testing.T) {
// 	var c mgr.Client
// 	c.ClientID = clientHandid
// 	c.APIKey = "123456"
// 	c.Enabled = false
...
// func TestRRt_HandleDelReq(t *testing.T) {
// 	//var routeBkStr string = strconv.FormatInt(routeBk, 10)
// 	//var CIDStr string = strconv.FormatInt(clientHandid, 10)
...
// func TestRRt_HandleDelMethod(t *testing.T) {
// 	//var routeBkStr string = strconv.FormatInt(routeBk, 10)
// 	var CIDStr string = strconv.FormatInt(clientHandid, 10)
// 	r, _ := http.NewRequest("GET", "/test?clientId="+CIDStr, nil)
// 	r.Header.Set("u-client-id", "24")
